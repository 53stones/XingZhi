...
public class AppHelpEventController {
    ...
    public Result<PageResult<HelpEventVO>> nearby(AppNearbyHelpQueryDTO dto) {
        ...
        System.out.println("Nearby request from user=" + currentUserId + ", latitude=" + dto.getLatitude() + ", longitude=" + dto.getLongitude() + ", radius=" + dto.getRadius());
        return Result.success(appHelpEventService.nearby(currentUserId, dto));
    }
