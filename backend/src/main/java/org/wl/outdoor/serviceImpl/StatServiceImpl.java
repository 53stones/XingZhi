...
public class StatServiceImpl implements StatService {
    ...
    public StatOverviewVO overview() {
        ...
        Long userCount = appUserMapper.selectCount(new LambdaQueryWrapper<>());
        Long adminCount = sysAdminMapper.selectCount(new LambdaQueryWrapper<>());
        Long helpEventCount = helpEventMapper.selectCount(new LambdaQueryWrapper<>());
